...
<script src="{{ url('stisla') }}/node_modules/moment/moment-timezone.js"></script>
<script src="{{ url('stisla') }}/assets/js/stisla.js"></script>

<!-- JS Libraies -->
<script src="{{ url('stisla') }}/node_modules/simpleweather/jquery.simpleWeather.min.js"></script>
<script src="{{ url('stisla') }}/node_modules/chart.js/dist/Chart.min.js"></script>
<script src="{{ url('stisla') }}/node_modules/jqvmap/dist/jquery.vmap.min.js"></script>
<script src="{{ url('stisla') }}/node_modules/jqvmap/dist/maps/jquery.vmap.world.js"></script>
