            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Admin</span>
                        </h4>
                        <p class="text-muted">Before you get started, you must login if you don't already have
                            an account.</p>
                        <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="text" class="form-control" name="email"
                                    value="{{ old('email') }}" tabindex="1" required required autofocus>
                                @error('email')
                        ...
                        <div class="text-center mt-5 text-small">
                            {{ str_replace('_', ' ', config('app.name', 'Laravel')) }} <div class="bullet">
