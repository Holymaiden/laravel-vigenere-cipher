...
use App\Repositories\Contracts\ClassStudentContract as ClassStudentRepo;
use App\Services\Contracts\ClassStudentContract;

class ClassStudentService implements ClassStudentContract
{
    protected $contractRepo;

    public function __construct(ClassStudentRepo $contractRepo)
    {
